...
function distortion() {
    var checkBox = document.getElementById("distortionControl");
    var channelText = document.getElementById("distortionText");

    if (checkBox.checked == true) {
        channelText.textContent = "No distortion";
        shttp.open("POST", "dist=1", true);
    } 
    else {
        channelText.textContent = "Distortion";
        shttp.open("POST", "dist=0", true);
    }
...
function octaver() {
    var checkBox = document.getElementById("octaverControl");
    var channelText = document.getElementById("octaverText");

    if (checkBox.checked == true) {
        channelText.textContent = "No octaver";
        shttp.open("POST", "octa=1", true);
    } 
    else {
        channelText.textContent = "Octaver";
        shttp.open("POST", "octa=0", true);
    }
...
function tremolo() {
    var checkBox = document.getElementById("tremoloControl");
    var channelText = document.getElementById("tremoloText");

    if (checkBox.checked == true) {
        channelText.textContent = "No tremolo";
        shttp.open("POST", "trem=1", true);
    } 
    else {
        channelText.textContent = "Tremolo";
        shttp.open("POST", "trem=0", true);
    }
...
function delay() {
    var checkBox = document.getElementById("delayControl");
    var channelText = document.getElementById("delayText");

    if (checkBox.checked == true) {
        channelText.textContent = "No delay";
        shttp.open("POST", "dela=1", true);
    } 
    else {
        channelText.textContent = "Delay";
        shttp.open("POST", "dela=0", true);
    }
